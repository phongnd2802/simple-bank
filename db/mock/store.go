...
// Source: github.com/phongnd2802/simple-bank/db/sqlc (interfaces: Store)
//
...
// UpateAccount mocks base method.
func (m *MockStore) UpateAccount(ctx context.Context, arg db.UpateAccountParams) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpateAccount", ctx, arg)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpateAccount indicates an expected call of UpateAccount.
func (mr *MockStoreMockRecorder) UpateAccount(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpateAccount", reflect.TypeOf((*MockStore)(nil).UpateAccount), ctx, arg)
}
...
func (m *MockStore) VerifyEmailTx(ctx context.Context, arg db.VeriyEmailTxParams) (db.VerifyEmailTxResult, error) {
	m.ctrl.T.Helper()
